...
def vmap(
  ...
  .. doctest::
     ...
     >>> f(x)
     DeviceArray([[255383827, 267815257],
                  [255383827, 267815257],
                  [255383827, 267815257],
     ...
     >>> f(x)
     DeviceArray([[ 252338135, 1967064809],
                  [3761284797, 3639683344],
                  [1904823939, 2453619898],
                  [ 289235907, 1886068298]], dtype=uint32)
